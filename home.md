...
<head>
    ...
    <meta name="p:domain_verify" content="956ed0c82f55b5a459abb2df913c1049" />
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">


    
    <link rel="shortcut icon" href="/latest-assets/images/fevicon.png" type="image/x-icon">
    <!--<link rel="preload" href="/latest-assets/fonts/proximanova-regular.woff2" as="font" type="font/woff2" crossorigin>-->
    <link rel="preload" href="/latest-assets/css/main-landing-2025.css" as="style">
    <link rel="preload" fetchpriority="high" as="image" href="/latest-assets/img/banner-2025-2.webp" type="image/webp" media="(min-width: 1200px)">
    <link rel="preload" fetchpriority="high" as="image" href="/latest-assets/img/arshdeep-inset-bg.webp" type="image/webp" media="(min-width: 1200px)">
    ...
    <link rel="preconnect" href="https://app.superbot.works">    
    <link rel="preconnect" href="https://fonts.googleapis.com">       
    <link rel="preconnect" href="https://www.google.com">    
    
    <link href="/latest-assets/css/main-landing-2025.css" rel="stylesheet">

    <link rel="apple-touch-icon" sizes="57x57" href="/add_to_homescreen/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="/add_to_homescreen/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="/add_to_homescreen/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="/add_to_homescreen/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="/add_to_homescreen/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="/add_to_homescreen/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="/add_to_homescreen/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="/add_to_homescreen/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="/add_to_homescreen/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192" href="/add_to_homescreen/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png">
    <link rel="manifest" href="/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="/add_to_homescreen/ms-icon-144x144.png">
    <meta name="theme-color" content="#ffffff">



    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-55121698-1"></script>
    <script defer>
        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());

        gtag('config', 'UA-55121698-1');
    </script>
    ...
    <script type="application/ld+json" defer>
        {
            ...
            "email": "mailto:admissions@cuchd.in",
            "potentialAction": {
                "@type": "SearchAction",
                "target": "https://www.cuchd.in/search_results?q={search_term}",
            ...
            "sameAs": [
                ...
                "https://x.com/Chandigarh_uni",
                "http://www.instagram.com/chandigarhuniversity/",
                "https://www.youtube.com/user/chandigarhuniversity",
                "https://www.linkedin.com/school/chandigarh-university/",
                "http://www.pinterest.com/chandigarhunive/boards/",
                "https://en.wikipedia.org/wiki/Chandigarh_University",
                "https://www.cuchd.in"
            ]
        }
    </script>
...
<body>
    ...
    <div id="tmr-cov" class="timer-box">
        <div class="time-content">
            <p>Application Window for PhD Programs Closes on<br> <span>30<sup>th</sup> November 2025</span></p>
        </div>
        <div class="low-time">
            <div id="demo" class="timer-demo"></div>
        </div>
        <a href="https://www.cuchd.in/phd-me-admissions/ApplicationRegistration.aspx?Subject=fJAt3RX8ggEX//eDGysKyA==" class="timer-btn btn-hoverEffect"
            target="_blank">Apply Now !</a>
        <button class="timer-close" type="button">&times;</button>
    </div>
...
<header class="header fixed-top">
                ...
                <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner text-center">
                        ...
                        <div class="carousel-item active" data-bs-interval="3000">
                         ...
                         <div class="carousel-item" data-bs-interval="3000">Embark on a Journey of Passion to Profession through Advanced Credit Program <a href="https://www.cuchd.in/acp/" target="_blank" class="xs-btn text-white">Register Now</a>
                        </div> 
                        <!--<div class="carousel-item" data-bs-interval="3000">TECHNICIA'25 – India’s Largest Tech Festival! Prizes Worth ₹6 Lakh | October 15–17 <a href="https://www.technicia.live/" target="_blank" class="xs-btn text-white">Register Now</a>
                        </div>--> 
                    </div>
                                                        ...
                                                        <div class="col-xl-6">
                                                            <ul class="list-unstyled p-0 m-0">
                                                                ...
                                                                <li><a
                                                                        ...
                                                                        in Applied Finance & Analytics <!--<img
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <ul class="list-unstyled p-0 m-0">
														...
														<li><a href="https://cuintranet.in/" target="_blank" rel="nofollow">Clubs, Communities, Department Societies &amp; Student Chapters
                                                                </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                ...
                                <div class="step-second-menu st-research">
                                    <div class="row g-0 h-100">
                                        <div class="col-lg-6 d-none d-xl-block lazy-bg"
                                            ...
                                            <div class="program-drop-down-graphic position-relative h-100 text-center d-flex flex-column justify-content-between">
    ...
    <div class="collapse" id="navbarToggleExternalContent">
                    ...
                    <div class="col-xl-7">
                        ...
                        <div class="institute-list">
                            <ul class="list-unstyled step-first-menu hover-header-list ps-0">
                                        ...
                                        <div class="row g-0 h-100">
                                            ...
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    ...
                                                    <h5 class="text-switch">A New Era in Engineering Education awaits you
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            ...
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column justify-content-between h-100 p-4 p-xxl-5">
                                                    <h5 class="text-switch">Become a top-notch Legal Professional a blend
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            ...
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column justify-content-between h-100 p-4 p-xxl-5">
                                                    <h5 class="text-switch">Be a future leader with a pioneering blend of
                                ...
                                <li>
                                    <a href="/applied-health-sciences/">University Institute of Allied Health
                                        Sciences</a>
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            ...
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column justify-content-between h-100 p-4 p-xxl-5">
                                                    <h5 class="text-switch">Embark on your journey with our comprehensive
        ...
        <section class="heroContainer position-relative">
            <div class="heroSlider h-100">
                <!--<div class="heroSlider__item" style="background-image: url('latest-assets/img/banner-2025-kohli.webp');"></div>-->
                <div class="heroSlider__item" style="background-image: url('latest-assets/img/banner-2025-akshay-bg.webp');"></div>
				<div class="heroSlider__item" style="background-image: url('latest-assets/img/banner-2025.webp');"></div>
                <div class="heroSlider__item" style="background-image: url('latest-assets/img/banner-2025-2.webp');"></div>
                <div class="heroSlider__item" style="background-image: url('latest-assets/img/banner-2025-sid-bg.webp');"></div>
                <div class="heroSlider__item" style="background-image: url('latest-assets/img/bbuzz-honey-bg.webp');"></div>
            </div>
                        ...
                        <div class="col-md-6 order-last order-sm-first">
                            <div class="heroSlider__content">
                                ...
                                <div class="ps-67">
                                    ...
                                    <div class="btn-grp">
                                        <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
                                            class="btn btn-primary btn-hoverEffect" target="_blank">Apply Today <img src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="ms-2"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="ps-67 pos-abs-mob">
                                <div class="hero-place-slider">
                                    <!--<div class="item">
                                        <div class="hp-info text-white">
                                            <div class="hpName">Ashish<span>Kohli</span></div>
                                            <div class="hpText">Sr. Product Manager</div>
                                        </div>
                                        <div class="hp-package text-white">
                                            <div class="hpTextbig">International <br>Package</div>                                            
                                            <div class="hpAmount"><sup>₹</sup>2.34 <span>CRORE</span></div>                                            
                                        </div>
                                        <div class="hpCompany">
                                            <img src="latest-assets/img/amazon-uk-logo.webp" alt="Amazon Logo" width="183">
                                        </div>                                        
                                    </div>-->  
                                    <div class="item">
                                        <div class="hp-info text-white">
                                            <div class="hpName">Akshay<span>Gandhi</span></div>
                                            <div class="hpText">Mechanical Engineering</div>
                                        </div>
                                        <div class="hp-package text-white">
                                            <div class="hpTextbig">International <br>Package</div>                                            
                                            <div class="hpAmount"><sup>₹</sup>1.0 <span>CRORE +</span></div>                                            
                                        </div>
                                        <div class="hpCompany invisible">
                                            <img src="latest-assets/img/amazon-uk-logo.webp" alt="Amazon Logo" width="183">
                                        </div>                                        
                                    </div> 
                                    <div class="item">
                                        <div class="hp-info text-white">
                                            <div class="hpName">Vandana<span>Chauhan</span></div>
                                            <div class="hpText">Computer Science Engineering</div>
                                        </div>
                                        <div class="hp-package text-white">
                                            <div class="hpTextbig">National <br>Highest Package</div>                                            
                                            <div class="hpAmount"><sup>₹</sup>54.75 <span>LPA</span></div>                                            
                                        </div>
                                        <div class="hpCompany">
                                            <img src="latest-assets/img/pan-logo-light.webp" alt="Paloalto Logo" width="183">
                                        </div>                                        
                                    </div>
									<div class="item">
                                        <div class="hp-info text-white">
                                            <div class="hpName">Arshdeep<span>Singh</span></div>
                                            <div class="hpText">International Cricketer</div>
                                        </div>
                                        <div class="hpCompany bcci-mark">
                                            <img src="latest-assets/img/bcci-logo.webp" alt="Board of Cricket Council Logo" width="63" style="width:63px!important;">
                                        </div> 
                                        <div class="hp-package text-white invisible">
                                            <div class="hpTextbig">National <br>Highest Package</div>                                            
                                            <div class="hpAmount"><sup>₹</sup>51.00 <span>LPA</span></div>                                            
                                        </div>                                    
                                    </div>  
                                    <div class="item">
                                        <div class="hp-info text-white">
                                            <div class="hpName">Siddhant<span>Bhardwaj</span></div>
                                            <div class="hpText">CSE-IBM Information Security</div>
                                        </div>
                                        <div class="hp-package text-white">
                                            <div class="hpTextbig">International <br>Highest Package</div>                                            
                                            <div class="hpAmount"><sup>₹</sup>1.7 <span>CRORE</span></div>                                            
                                        </div>
                                        <div class="hpCompany invisible">
                                            <img src="latest-assets/img/dame-munni-cap.webp" alt="Dame Irone logo" width="183">
                                        </div>                                        
                                    </div>    
                                    
                                    <div class="item">
                                        <div class="hp-info text-white">
                                            <div class="hpName">Parbhat <span>Phogat</span></div>
                                            <div class="hpText">CU Alumni & CEO - BBuzzHoney</div>
                                        </div>
                                        <div class="hp-package text-white">
                                            <div class="hpTextbig">Turnover <br>(2024-2025)</div>                                            
                                            <div class="hpAmount"><sup>₹</sup>2.5 <span>CRORE</span></div>                                            
                                        </div>
                                        <div class="hpCompany">
                                            <img src="latest-assets/img/bbuzz-honey-logo.webp" alt="bbuzzhoney logo" width="70" style="width:55px!important">
                                        </div>                                        
                                    </div>   
                                </div>                        
                            </div>
...
<span class="end_date">Registration End Date (Phase - 1): 1<sup>st</sup> May 2026</span>                                </div>
                                <div id="lsq-portal-widget-26c2650d-9b4a-11ef-8bcb-06998e7502ab-bcb99b86-42be-40c9-a606-fd96a6e329f8"
                                    ...
                                    <script src="https://portal-widgets.lsqportal.com/assets/bootstrap-widget.js"
                                        data-widget-id="26c2650d-9b4a-11ef-8bcb-06998e7502ab"
                                        data-version-id="bcb99b86-42be-40c9-a606-fd96a6e329f8"
                ...
                <div class="another-one">
                    <!--<div class="hp-photo">
                        <img src="latest-assets/img/ashish-inset-bg.webp" alt="Ashish Photo">
                    </div>-->      
                    <div class="hp-photo">
                        <img src="latest-assets/img/akshay-inset-bg.webp" alt="Akshay Photo">
                    </div> 
                    <div class="hp-photo">
                        <img src="latest-assets/img/vc-inset-bg.webp" alt="Vandana Photo">
                    </div>
					<div class="hp-photo">
    ...
    <section class="topHighlights-section pt-115 pb-115 position-relative">
        <div class="qsRanking" data-aos="fade-up" data-aos-duration="500">
            <div class="container px-188 px-1399">
                <div class="highlight-sl">
                    <div class="ra-item">
                        <img data-src="latest-assets/img/qs-asia-2026-banner.jpg" alt="QS Asia Rankings for CU 2026" class="w-100 desktopRankings lazy-img">
                        <img data-src="latest-assets/img/qs-asia-2026-mobile-banner.jpg" alt="QS Asia Rankings for CU 2026" class="w-100 mobileRankings lazy-img">
                        <a href="https://www.cuchd.in/qs-asia-university-rankings-2026/" target="_blank" class="btn btn-primary btn-hoverEffect">Read More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a> 
                    </div>  
                    <div class="ra-item">
                        <img data-src="latest-assets/img/nirf-2025-banner.webp" alt="NIRF Rankings for CU 2025" class="w-100 desktopRankings lazy-img">
                        <img data-src="latest-assets/img/nirf-2025-mobile-banner.webp" alt="NIRF Rankings for CU 2025" class="w-100 mobileRankings lazy-img">
                        <a href="https://www.cuchd.in/nirf-university-rankings-2025/" target="_blank" class="btn btn-primary btn-hoverEffect">Read More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a> 
                    </div>  
                    <!--<div class="ra-item">
                        <img data-src="latest-assets/img/campus_tank.webp" alt="Campus Tank" class="w-100 desktopRankings lazy-img">
                        <img data-src="latest-assets/img/campus_tank_mobile.webp" alt="Campus Tank" class="w-100 mobileRankings lazy-img">
                        <a href="https://www.campustank.com/" target="_blank" class="btn btn-primary btn-hoverEffect">Read More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a> 
                    </div>-->  
                    <div class="ra-item">                    
                        <img data-src="latest-assets/img/qsRaninking-2026.webp" alt="QS World Universities Rankings" class="w-100 desktopRankings lazy-img">
                        <img data-src="latest-assets/img/qsRaninking-2026-mob.webp" alt="" class="w-100 mobileRankings lazy-img">
                        <a href="https://www.cuchd.in/qs-world-university-rankings-2026/" target="_blank" class="btn btn-primary btn-hoverEffect">Read More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a>
                    </div> 
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="mainHeading text-center">
                <h2 data-aos="fade-up" data-aos-duration="500">An <span>Illustrious</span> Legacy we<br> continue to Shape</h2>
            </div>
            <div class="topHighlights__numbers px-188 px-1399 d-flex justify-content-between" id="counter-section1">
                <div class="tpNumbersCard">
                    <span class="count plusIcon" data-count="154">0</span>
                    <div class="tpNumbersCard__title" data-aos="fade-up" data-aos-duration="500">PROGRAMS</div>
                    <p data-aos="fade-right" data-aos-duration="600">Industry-Oriented<br>Academic Programs</p>
                </div>
                <div class="tpNumbersCard">
                    <span class="count plusIcon" data-count="980">0</span>
                    <div class="tpNumbersCard__title" data-aos="fade-up" data-aos-duration="500">STALWARTS</div>
                    <p data-aos="fade-right" data-aos-duration="600">Industry Stalwarts for<br>Top-Tier Mentorship</p>
                </div>
                <div class="tpNumbersCard">
                    <span class="count plusIcon" data-count="1350">0</span>
                    <div class="tpNumbersCard__title" data-aos="fade-up" data-aos-duration="500">FACULTY</div>
                    <p data-aos="fade-right" data-aos-duration="600">Doctoral<br>Faculty</p>
                </div>
                <div class="tpNumbersCard">
                    <span class="count plusIcon" data-count="300">0</span>
                    <div class="tpNumbersCard__title" data-aos="fade-up" data-aos-duration="500">FACULTY</div>
                    <p data-aos="fade-right" data-aos-duration="600">International<br>Faculty</p>
                </div>
                <div class="tpNumbersCard">
                    <span class="count plusIcon" data-count="100000">0</span>
                    <div class="tpNumbersCard__title" data-aos="fade-up" data-aos-duration="500">ALUMNI</div>
                    <p data-aos="fade-right" data-aos-duration="600">Accomplished Alumni<br>Across the Globe</p>
                </div>
            </div>
            <div class="topNewsSection position-relative">
                <div class="row" data-aos="fade-up" data-aos-duration="500">
                    <div class="col-xl-12">
                        <div class="topHighlights__news position-relative">
                            <div class="topHighlights__slider">
                                <div class="ths-item">
                                    <div class="card border-0 h-100 overflow-hidden br-10 lazy-bg"
                                        style="background-image:url('latest-assets/img/topHighlights-placeholder-bg.webp'); background-size: cover;"
								...
								<div class="ths-item">
                                    <div class="card border-0 h-100 overflow-hidden br-10 lazy-bg"
                                        ...
                                        <div class="card-footer bg-transparent p-0">
                                            <div class="newsTags">
                                                Start Ups <span>|</span> Entrepreneurship
                                            </div>
                                        </div>
                                    </div>
                                </div>
								<div class="ths-item">
                                    <div class="card border-0 h-100 overflow-hidden br-10 lazy-bg"
                                        ...
                                        <div class="card-footer bg-transparent p-0">
                                            <div class="newsTags">
                                                Adobe <span>|</span> Industry Partnerships
                                            </div>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="ths-item">
                                    <div class="card border-0 h-100 overflow-hidden br-10 lazy-bg"
                                        style="background-image:url('latest-assets/img/topHighlights-placeholder-bg.webp'); background-size: cover;"
                                        data-bg="latest-assets/img/cu-bharat-img.webp">
                                        <div class="card-body"></div>
                                        <div class="video-play-icon">
                                            <a rel="nofollow" href="https://www.youtube.com/watch?v=ZBOTbaVd7mI" target="_blank" class="video-play-button">
                                                <span></span>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="ths-item">
                                    <div class="card border-0 h-100 overflow-hidden br-10 lazy-bg"
                                        style="background-image:url('latest-assets/img/topHighlights-placeholder-bg.webp'); background-size: cover;"
                                        data-bg="latest-assets/img/kabaddi-asia-champion.webp">
                                        <div class="card-body p-0 d-flex justify-content-end">
                                            <div class="nw-cont">
                                                <h6>MA Student Sakshi Sharma wins GOLD MEDAL at the 6th Asian Kabaddi
                                                Championship held in Iran</h6>
                                                <p>Sakshi Sharma, Indian Women's Kabaddi Player and second-year MA student, has made CU incredibly proud by winning GOLD ...</p>
                                                <a href="https://www.facebook.com/chandigarhuniversitygharuan/posts/pfbid024pEmv7ezHVEtc3L1gaDPMyLfiRBjkxzQorszXxT6kea6FH1733FSxzgwBh2myYgSl" class="btn btn-primary btn-hoverEffect" target="_blank" rel="nofollow">Read More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="16" class="lazy-img ms-2"></a>
                                            </div>
                                        </div>
                                        <div class="card-footer bg-transparent p-0">
                                            <div class="newsTags">
                                                Achievement <span>|</span> Sports
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="ths-item">
                                    <div class="card border-0 h-100 overflow-hidden br-10 lazy-bg"
                                        style="background-image:url('latest-assets/img/topHighlights-placeholder-bg.webp'); background-size: cover;"
                                        data-bg="latest-assets/img/topHighlights-maka-trophy.webp">
                                        <div class="card-body p-0 d-flex justify-content-end">
                                            <div class="nw-cont">
                                ...
                                <div class="ths-item">
                                    <div class="card border-0 h-100 overflow-hidden br-10 lazy-bg"
                                        style="background-image:url('latest-assets/img/topHighlights-placeholder-bg.webp'); background-size: cover;"
                                        data-bg="latest-assets/img/topHighlights-anupam-mittal.webp">
                                        <div class="card-body p-0 d-flex justify-content-end">
                                            <div class="nw-cont">
                                                <h6>CU-TBI Celebrates National Startup Day with SANDBOX 2025, Featuring Mr.
                                                Anupam Mittal</h6>
                                                <p>The event provided a platform for startups to connect with mentors, industry experts, and investors. Participants explored ...</p>
                                                <a href="https://news.cuchd.in/2025/01/cu-tbi-celebrates-national-startup-day.html" class="btn btn-primary btn-hoverEffect" target="_blank">Read More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="16" class="lazy-img ms-2"></a>
                                            </div>
                                        </div>
                                        <div class="card-footer bg-transparent p-0">
                                            <div class="newsTags">
                                                Sandbox <span>|</span> Entrepreneurship
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="ths-item">
                                    <div class="card border-0 h-100 overflow-hidden br-10 lazy-bg"
                                        style="background-image:url('latest-assets/img/topHighlights-placeholder-bg.webp'); background-size: cover;"
                                        data-bg="latest-assets/img/topHighlights-sanjay-kumar.webp">
                                        <div class="card-body p-0 d-flex justify-content-end">
                                            <div class="nw-cont">
                                ...
                                <div class="ths-item">
                                    <div class="card border-0 h-100 overflow-hidden br-10 lazy-bg"
                                        style="background-image:url('latest-assets/img/topHighlights-placeholder-bg.webp'); background-size: cover;"
                                        data-bg="latest-assets/img/topHighlights-amanGupta.webp">
                                        <div class="card-body p-0 d-flex justify-content-end">
                                            <div class="nw-cont">
                                ...
                                <div class="ths-item">
                                    <div class="card border-0 h-100 overflow-hidden br-10 lazy-bg"
                                        style="background-image:url('latest-assets/img/topHighlights-placeholder-bg.webp'); background-size: cover;"
                                        data-bg="latest-assets/img/topHighlights-worldRecord.webp">
                                        <div class="card-body p-0 d-flex justify-content-end">
                                            <div class="nw-cont">
                                                <h6>CU creates Guinness World Record for largest human image of waving
                                                National Flag</h6>
                                                <p>Strengthening Prime Minister Shri Narendra Modi’s ongoing ‘Har Ghar Tiranga’ campaign and taking it to international ...</p>
                                                <a href="https://news.cuchd.in/2022/08/chandigarh-university-create-guinness.html" class="btn btn-primary btn-hoverEffect" target="_blank">Read More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="16" class="lazy-img ms-2"></a>
                                            </div>
                                        </div>
                                        <div class="card-footer bg-transparent p-0">
                                            <div class="newsTags">
                                                Achievement <span>|</span> World Record
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="ths-item">
                                    <div class="card border-0 h-100 overflow-hidden br-10 lazy-bg"
                                        style="background-image:url('latest-assets/img/topHighlights-placeholder-bg.webp'); background-size: cover;"
                                        data-bg="latest-assets/img/topHighlights-indiaNavy.webp">
                                        <div class="card-body p-0 d-flex justify-content-end">
                                            <div class="nw-cont">
                                                <h6>CSE Student commissioned into the Officer Cadre of the Indian Navy!</h6>
                                                <p>We are delighted to announce that Ashi Sharma, a distinguished B.E. CSE student and NCC Army Wing Cadet from the 2020 batch ...</p>
                                                <a href="https://news.cuchd.in/2024/11/cse-student-commissioned-into-officer.html" class="btn btn-primary btn-hoverEffect" target="_blank">Read More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="16" class="lazy-img ms-2"></a>
                                            </div>
                                        </div>
                                        <div class="card-footer bg-transparent p-0">
                                            <div class="newsTags">
                                                Achievement <span>|</span> Indian Navy
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="ths-item">
                                    <div class="card border-0 h-100 overflow-hidden br-10 lazy-bg"
                                        style="background-image:url('latest-assets/img/topHighlights-placeholder-bg.webp'); background-size: cover;"
                                        data-bg="latest-assets/img/topHighlights-placement.webp">
                                        <div class="card-body p-0 d-flex justify-content-end">
                                            <div class="nw-cont">
                                ...
                                <div class="ths-item">
                                    <div class="card border-0 h-100 overflow-hidden br-10 lazy-bg"
                                        style="background-image:url('latest-assets/img/topHighlights-placeholder-bg.webp'); background-size: cover;"
                                        data-bg="latest-assets/img/topHighlights-areospace.webp">
                                        <div class="card-body p-0 d-flex justify-content-end">
                                            <div class="nw-cont">
                                ...
                                <div class="ths-item">
                                    <div class="card border-0 h-100 overflow-hidden br-10 lazy-bg"
                                        style="background-image:url('latest-assets/img/topHighlights-placeholder-bg.webp'); background-size: cover;"
                                        data-bg="latest-assets/img/topHighlights-unionMinster.webp">
                                        <div class="card-body p-0 d-flex justify-content-end">
                                            <div class="nw-cont">
                                                <h6>Union Minister inaugurates Kalpana Chawla Centre for Research in Space
                                                Science &amp; Technology</h6>
                                                <p>Reiterating the government’s commitment of strengthening the private sector for the holistic development of the nation...</p>
                                                <a href="https://news.cuchd.in/2022/01/defence-minister-rajnath-singh.html" class="btn btn-primary btn-hoverEffect" target="_blank">Read More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="16" class="lazy-img ms-2"></a>
                                            </div>
                                        </div>
                                        <div class="card-footer bg-transparent p-0">
                                            <div class="newsTags">
                                                Research <span>|</span> Technology
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-12 px-188 px-1399">
                        <div class="whatsNew__notifications position-relative">
                            <div class="notifications__slider" data-aos="fade-up" data-aos-duration="500">
                                <div class="ns-item">
                                    <div class="card h-100 overflow-hidden br-10 p-4">
                                        <div class="card-body p-0 p-sm-2">
                                            <span class="notiTitle">NCAIPEM 2025</span>
                                            <span class="notiHeading">National Conference on Artificial Intelligence as a Catalyst for Change in Healthcare, PE and ME</span>
                                        </div>
                                        <div class="card-footer border-0 bg-transparent p-2 text-end">
                                            <a href="https://www.cuchd.in/conference/ncaipem/" class="btn btn-primary btn-hoverEffect" target="_blank" >Register Now <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="ns-item">
                                    <div class="card h-100 overflow-hidden br-10 p-4">
                                        <div class="card-body p-0 p-sm-2">
                                            <span class="notiTitle">ITIDS 2025</span>
                                            <span class="notiHeading">Information Technologies for Intelligent Decision Support with Ufa University, Russia </span>
                                        </div>
                                        <div class="card-footer border-0 bg-transparent p-2 text-end">
                                            <a href="https://www.cuchd.in/conference/itids-25/" class="btn btn-primary btn-hoverEffect" target="_blank">Register Now <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="ns-item">
                                    <div class="card h-100 overflow-hidden br-10 p-4">
                                        <div class="card-body p-0 p-sm-2">
                                            <span class="notiTitle">ICSAHSE 2026</span>
                                            <span class="notiHeading">International Conference on Smart Agriculture, Healthcare, and Sustainable Energy</span>
                                        </div>
                                        <div class="card-footer border-0 bg-transparent p-2 text-end">
                                            <a href="https://www.cuchd.in/conference/icsahse/" class="btn btn-primary btn-hoverEffect" target="_blank">Register Now <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a>
                                        </div>
                                    </div>
                                </div>
                                <!--<div class="ns-item">
                                    <div class="card h-100 overflow-hidden br-10 p-4">
                                        <div class="card-body p-0 p-sm-2">
                                            <span class="notiTitle">ICBBE 2026</span>
                                            <span class="notiHeading">2nd International Conference on Biomanufacturing, Bio-Innovation, and Environment</span>
                                        </div>
                                        <div class="card-footer border-0 bg-transparent p-2 text-end">
                                            <a href="https://www.cuchd.in/conference/icbbe-26/" class="btn btn-primary btn-hoverEffect" target="_blank">Register Now <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a>
                                        </div>
                                    </div>
                                </div>-->
                            </div>
    ...
    <section class="allRankings-section pb-115 position-relative" data-aos="fade-up" data-aos-duration="500">
        <div class="container">
            <div class="mainHeading text-center" data-aos="fade-up" data-aos-duration="700">
                <h2 class="px-4 px-sm-0"><span>Proudly Distinguished</span> by Our Prestigious<br> Rankings and Accreditations</h2>
            </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq-head-2">
                            <button class="accordion-button collapsed" type="button"
                                ...
                                aria-expanded="false" aria-controls="faq-collapse-2" disabled>
                                <div class="row g-0 w-94">
                                    <div class="col-5 col-sm-4 col-md-3">
                                        <img class="lazy-img" data-src="latest-assets/img/qsasia.webp" alt="QS University Rankings Asia" width="225">
                                    </div>
                                    <div class="col-7 col-sm-8 col-md-9">
                                        <div class="row">
                                            <div class="col-md-12 col-lg-6">
                                                <div class="uniRankingthumb">
                                                    <div class="uniRankingthumb__no">
                                                        <span>Ranked</span>                                                                
                                                        #1
                                                    </div>
                                                    <div class="uniRankingthumb__content">
                                                        Among India's Top Ranked Private Universities in the QS Asia University Rankings 2026
                                                        <span>(Overall Rank #109)</span>
                                                    </div>
                                                </div>                                                  
                                            </div> 
                                        </div>
                        ...
                        <div id="faq-collapse-2" class="accordion-collapse collapse"
                            aria-labelledby="faq-head-2" data-bs-parent="#accordionFlushExampleFAQ">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq-head-1">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                <div class="row g-0 w-94">
                                    <div class="col-5 col-sm-4 col-md-3">
                                        <img class="lazy-img" data-src="latest-assets/img/WUR-logo.webp" alt="QS World University Rankings" width="225">
                                    </div>
                                    <div class="col-7 col-sm-8 col-md-9">
                                        <div class="row">
                                            <div class="col-md-12 col-lg-6">
                                                <div class="uniRankingthumb">
                                                    ...
                                                    <div class="uniRankingthumb__content">
                                                        Among World's Top Universities in QS World University Rankings by Subject 2025
                                            ...
                                            <div class="col-md-12 col-lg-6 d-none d-lg-block">
                                                <div class="uniRankingthumb">
                                                    ...
                                                    <div class="uniRankingthumb__content">
                                                        Among World's Top Universities in QS World University Rankings by Subject 2025
                                                        <span>(Social Sciences &amp; Management)</span>
                                                    </div>
                                                </div>                                                  
                                            </div>
                                        </div>
                        ...
                        <div id="faq-collapse-1" class="accordion-collapse collapse"
                            aria-labelledby="faq-head-1" data-bs-parent="#accordionFlushExampleFAQ"> <!-- 'collapse show' -->
                            <div class="accordion-body">
                                <div class="row g-0 w-94">
                                        ...
                                        <div class="row">
                                            <div class="col-6 mb-40">
                                                <div class="uniRankingthumb">
                                                    ...
                                                    <div class="uniRankingthumb__content">
                                                        Among World's Top Universities in QS World University Rankings by Subject 2025
                                                        <span>(Computer Science and Information Systems)</span>
                                                    </div>
                                                </div>                                                  
                                            </div> 
                                            <div class="col-6 mb-40">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq-head-3">
                            <button class="accordion-button collapsed" type="button"
                                ...
                                <div class="row g-0 w-94">
                                    <div class="col-5 col-sm-4 col-md-3">
                                        <img class="lazy-img" data-src="latest-assets/img/nirf-ranking-logo.webp" alt="NIRF Ranking" width="225">
                                    </div>
                                    <div class="col-7 col-sm-8 col-md-9">
                                        <div class="row">
                                            <div class="col-md-12 col-lg-6">
                                            ...
                                            <div class="col-md-12 col-lg-6 d-none d-lg-block">
                                                <div class="uniRankingthumb">
                                                    ...
                                                    <div class="uniRankingthumb__content">
                                                        Among The Best Institutions For Engineering In India By NIRF Rankings 2025
                                                    </div>
                                                </div>                                                   
                                            </div>
                                        </div>
                        ...
                        <div id="faq-collapse-3" class="accordion-collapse collapse"
                            aria-labelledby="faq-head-3" data-bs-parent="#accordionFlushExampleFAQ">
                            <div class="accordion-body">
                                <div class="row g-0 w-94">
                                    <div class="offset-md-3 col-md-9">
                                        <div class="row">
                                            <div class="col-6 mb-40">
                                                <div class="uniRankingthumb">
                                                    ...
                                                    <div class="uniRankingthumb__content">
                                                        Among The Best Institutions For Management Studies In India By NIRF Rankings 2025
                                                    </div>
                                                </div>                                                  
                                            </div> 
                                            <div class="col-6 mb-40">
                                                <div class="uniRankingthumb">
                                                    ...
                                                    <div class="uniRankingthumb__content">
                                                        Among The Best Institutions For Pharmacy In India By NIRF Rankings 2025
                                                    </div>
                                                </div>                                                   
                                            </div> 
                                            <div class="col-6">
                                                <div class="uniRankingthumb">
                                                    ...
                                                    <div class="uniRankingthumb__content">
                                                        Among The Best Institutions For Architecture &amp; Planning In India By NIRF Rankings 2025
                                                    </div>
                                                </div>                                                  
                                            </div>       
                                            <div class="col-6 d-block d-lg-none">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq-head-4">
                            <button class="accordion-button collapsed" type="button"
                                ...
                                aria-expanded="false" aria-controls="faq-collapse-4" disabled>
                                <div class="row w-94 align-items-center">
                                    <div class="col-5 col-sm-4 col-md-3">
                                        <img class="lazy-img" data-src="latest-assets/img/abet-logo.webp" alt="QS World University Rankings" width="220">
                                    </div>
                                    <div class="col-7 col-sm-8 col-md-3">
                                        <div class="uniRankingthumb">
                                            <div class="uniRankingthumb__content">
                                                ABET Accreditation For Globally Recognized Engineering Programs
                                                <span>All Engineering Programs</span>
                                            </div>
                                        </div> 
                                    </div>     
                                    <div class="col-md-3 d-none d-md-block">
                                        <img class="lazy-img" data-src="latest-assets/img/abet-logo-comp.webp" alt="QS World University Rankings" width="220">
                                    </div>
                                    <div class="col-md-3 d-none d-md-block">
                                        <div class="uniRankingthumb">
                                            <div class="uniRankingthumb__content">
                                                ABET Accreditation For Globally Recognized Engineering Programs
                                                <span>All CSE Programs</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="faq-collapse-4" class="accordion-collapse collapse"
                            aria-labelledby="faq-head-4" data-bs-parent="#accordionFlushExampleFAQ">
                            <div class="accordion-body">
                                <div class="row g-0 w-94">
    ...
    <section class="uniPlacement-section position-relative">
        <div class="container">
            <div class="row order-xs-set">
                <div class="col-lg-6">
                    <div class="topStudents-slider" data-aos="fade-right" data-aos-duration="500">
                        <div class="topStudent-item">
                            <div class="topStudent-item__card card border-0 position-relative h-100 lazy-bg" style="background-image:url('latest-assets/img/studentslide-placeholder-bg.webp');" data-bg="latest-assets/img/amazon-new-bg.webp">
                                <div class="card-body p-0">
                                    <span class="tsCompany">
                                        <img class="lazy-img" data-src="latest-assets/img/amazon-logo-cap.webp" alt="Amazon" width="157">
                                    </span>                                    
                                    <div class="topStudent__info">
                                        <span class="tsName">Abhyansh<small>Agrahari</small></span>
                                        <span class="tsText">- Placed in Amazon</span>
                                        <div class="topStudent__package">
                                            <span class="tsText mt-0">Salary Package</span>
                                            <span class="tsAmount"><sup>&#8377</sup>60.00 <div class="lpa">LPA</div></span>
                                        </div>                                        
                                    </div>
                                    <div class="topStudent__photo">
                                        <img class="lazy-img" data-src="latest-assets/img/top-student-abhyansh.webp" alt="Abhyansh Photo" width="300">
                                    </div>
                                </div>
                            </div>
                        </div>     
                        <div class="topStudent-item">
                            <div class="topStudent-item__card card border-0 position-relative h-100 lazy-bg" style="background-image:url('latest-assets/img/studentslide-placeholder-bg.webp');" data-bg="latest-assets/img/paloalto-bg.webp">
                                <div class="card-body p-0">
                                    <span class="tsCompany">
                                        <img class="lazy-img" data-src="latest-assets/img/pan-logo-light-color.webp" alt="Paloalto" width="157">
                                    </span>                                    
                                    <div class="topStudent__info">
                                        <span class="tsName">Vandana<small>Chauhan</small></span>
                                        <span class="tsText">- Placed in Paloalto</span>
                                        <div class="topStudent__package">
                                            <span class="tsText mt-0">Salary Package</span>
                                            <span class="tsAmount"><sup>&#8377</sup>54.75 <div class="lpa">LPA</div></span>
                                        </div>                                        
                                    </div>
                                    <div class="topStudent__photo">
                                        <img class="lazy-img" data-src="latest-assets/img/top-student-vandanaChauhan.webp" alt="Vandana Photo" width="300">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="topStudent-item">
                            <div class="topStudent-item__card card border-0 position-relative h-100 lazy-bg" style="background-image:url('latest-assets/img/studentslide-placeholder-bg.webp');" data-bg="latest-assets/img/volvo-bg.webp">
                                <div class="card-body p-0">
                                    <span class="tsCompany">
                                        <img class="lazy-img" data-src="latest-assets/img/volvo-logo.webp" alt="Volvo" width="157">
                                    </span>                                    
                                    <div class="topStudent__info">
                                        <span class="tsName">Kunal<small>Chawla</small></span>
                                        <span class="tsText">- Placed in Volvo</span>
                                        <div class="topStudent__package">
                                            <span class="tsText mt-0">Salary Package</span>
                                            <span class="tsAmount"><sup>&#8377</sup>54.00 <div class="lpa">LPA</div></span>
                                        </div>                                        
                                    </div>
                                    <div class="topStudent__photo">
                                        <img class="lazy-img" data-src="latest-assets/img/top-student-kunal.webp" alt="Kunal Photo" width="300">
                                    </div>
                                </div>
                            </div>
                        </div>                          
                        <div class="topStudent-item">
                            <div class="topStudent-item__card card border-0 position-relative h-100 lazy-bg" style="background-image:url('latest-assets/img/studentslide-placeholder-bg.webp');" data-bg="latest-assets/img/amazon-bg.webp">
                                <div class="card-body p-0">
                                    <span class="tsCompany">
                                        <img class="lazy-img" data-src="latest-assets/img/amazon-logo-cap.webp" alt="Amazon" width="157">
                                    </span>                                    
                                    <div class="topStudent__info">
                                        <span class="tsName">Harsh<small>Vardhan</small></span>
                                        <span class="tsText">- Placed in Amazon</span>
                                        <div class="topStudent__package">
                                            <span class="tsText mt-0">Salary Package</span>
                                            <span class="tsAmount"><sup>&#8377</sup>44.00 <div class="lpa">LPA</div></span>
                                        </div>                                        
                                    </div>
                                    <div class="topStudent__photo">
                                        <img class="lazy-img" data-src="latest-assets/img/top-student-harsh.webp" alt="Harsh Photo" width="300">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="topStudent-item">
                            <div class="topStudent-item__card card border-0 position-relative h-100 lazy-bg" style="background-image:url('latest-assets/img/studentslide-placeholder-bg.webp');" data-bg="latest-assets/img/microsoft-building-bg.webp">
                                <div class="card-body p-0">
                                    <span class="tsCompany">
                                        <img class="lazy-img" data-src="latest-assets/img/microsoft-logo-cap.webp" alt="Microsoft" width="157">
                                    </span>                                    
                                    <div class="topStudent__info">
                                        <span class="tsName">Shanya<small>Trehan</small></span>
                                        <span class="tsText">- Placed in Microsoft</span>
                                        <div class="topStudent__package">
                                            <span class="tsText mt-0">Salary Package</span>
                                            <span class="tsAmount"><sup>&#8377</sup>51.00 <div class="lpa">LPA</div></span>
                                        </div>                                        
                                    </div>
                                    <div class="topStudent__photo">
                                        <img class="lazy-img" data-src="latest-assets/img/top-student-shanya.webp" alt="Shanya Photo" width="300">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="topStudent-item">
                            <div class="topStudent-item__card card border-0 position-relative h-100 lazy-bg" style="background-image:url('latest-assets/img/studentslide-placeholder-bg.webp');" data-bg="latest-assets/img/irone-bg.webp">
                                <div class="card-body p-0">
                                    <span class="tsCompany">
                                        <img class="lazy-img" data-src="latest-assets/img/dame-munni-cap.webp" alt="Dr. Dame Munni Irone" width="157">
                                    </span>                                    
                                    <div class="topStudent__info">
                                        <span class="tsName">Siddhant <small>Bhardwaj</small></span>
                                        <span class="tsText">- Hired by Dr. Dame Munni Irone <br>(Author, Educator &amp; Humanitarian)</span>
                                        <div class="topStudent__package">
                                            <span class="tsText mt-0">Salary Package</span>
                                            <span class="tsAmount"><sup>&#8377</sup>1.7 <div class="lpa">CRORE</div></span>
                                        </div>                                        
                                    </div>
                                    <div class="topStudent__photo">
                                        <img class="lazy-img" data-src="latest-assets/img/top-student-siddhant.webp" alt="Siddhant Photo" width="300">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="topStudent-item">
                            <div class="topStudent-item__card card border-0 position-relative h-100 lazy-bg" style="background-image:url('latest-assets/img/studentslide-placeholder-bg.webp');" data-bg="latest-assets/img/nutanix-building-bg.webp">
                                <div class="card-body p-0">
                                    <span class="tsCompany">
                                        <img class="lazy-img" data-src="latest-assets/img/nutanix-logo-cap.webp" alt="Paloalto" width="157">
                                    </span>                                    
                                    <div class="topStudent__info">
                                        <span class="tsName">Gaurav<small>Kumar</small></span>
                                        <span class="tsText">- Placed in Nutanix</span>
                                        <div class="topStudent__package">
                                            <span class="tsText mt-0">Salary Package</span>
                                            <span class="tsAmount"><sup>&#8377</sup>51.00 <div class="lpa">LPA</div></span>
                                        </div>                                        
                                    ...
                                    <div class="topStudent__photo">
                                        <img class="lazy-img" data-src="latest-assets/img/top-student-gaurav.webp" alt="Gaurav Photo" width="300">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="mainHeading mb-0 position-relative text-center text-sm-start" data-aos="fade-left" data-aos-duration="500">
                        <p>Placements Overview</p>                        
                        <h2><span>The World's</span> Leading Companies Hire Our Talent</h2>
                    </div> 
                    <div class="mt-5 btnsGroup" data-aos="fade-left" data-aos-duration="500">
                        <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary btn-hoverEffect" target="_blank">Apply Now <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a>
                        <a href="/placements/" class="btn btn-primary bg-white text-dark btn-hoverEffect border ms-2" target="_blank">View Placements <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a>                       
                    </div>                    
                    <div class="cuPlacement-numbers my-5">
                        <div class="row g-2">
                            <div class="col-6 col-lg-3">
                                <div class="placementNo bigpl">
                                    <span class="placementNo__num">9000+</span>
                                    <span class="placementNo__title">Placement <br>Offers</span>
                                </div>
                            </div>
                            <div class="col-6 col-lg-3">
                                <div class="placementNo">
                                    <span class="placementNo__num">1100+</span>
                                    <span class="placementNo__title">Companies Visited<br> for Recruitment</span>
                                </div>
                            </div>
                            <div class="col-6 col-lg-3">
                                <div class="placementNo text-white bg-dark">
                                    <span class="placementNo__num">54.75<sub>LPA</sub></span>
                                    <span class="placementNo__title">Highest National<br> Package Offered</span>
                                </div>
                            </div>
                            <div class="col-6 col-lg-3">
                                <div class="placementNo">
                                    <span class="placementNo__num">1.7<sub>CR</sub></span>
                                    <span class="placementNo__title">Highest International<br> Package Offered</span>
                                </div>
                            </div>
                        </div>
                        <div class="borderLines">
                            <div class="placementNo" data-aos="fade-left" data-aos-duration="500">
                                <span class="placementNo__num">20<sub>LPA</sub></span>
                                <span class="placementNo__title">Package Offered by<br> <strong>30+</strong> Companies</span>
                            </div>
                            <div class="placementNo" data-aos="fade-left" data-aos-duration="700">
                                <span class="placementNo__num">15<sub>LPA</sub></span>
                                <span class="placementNo__title">Package Offered by<br> <strong>50+</strong> Companies</span>
                            </div>
                            <div class="placementNo" data-aos="fade-left" data-aos-duration="900">
                                <span class="placementNo__num">10<sub>LPA</sub></span>
                                <span class="placementNo__title">Package Offered by<br> <strong>100+</strong> Companies</span>
                            </div>
                            <div class="placementNo" data-aos="fade-left" data-aos-duration="1100">
                                <span class="placementNo__num">7<sub>LPA</sub></span>
                                <span class="placementNo__title">Package Offered by<br> <strong>300+</strong> Companies</span>
                            </div>
                            <div class="placementNo" data-aos="fade-left" data-aos-duration="1300">
                                <span class="placementNo__num">5<sub>LPA</sub></span>
                                <span class="placementNo__title">Package Offered by<br> <strong>500+</strong> Companies</span>
                            </div>
                        </div>
                    </div>                    
                </div>
            ...
            <div class="topCompanies-block">
                <div class="mainHeading text-center mb-5" data-aos="fade-up" data-aos-duration="500">
                    <p>Top-Tier Companies in Our Placement Network</p>
                </div>                
                <div class="topCompaniesLogo-slider">
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-2.webp" alt="Google logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-6.webp" alt="Amazon logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-17.webp" alt="Dell logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-18.webp" alt="HP logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-1.webp" alt="IBM logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-7.webp" alt="Flipkart logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-19.webp" alt="KPMG logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-20.webp" alt="Deloitte logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-21.webp" alt="Sapient logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-15.webp" alt="Cognizant logo"
                            width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-22.webp" alt="VMware logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-23.webp" alt="Schindler logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-24.webp" alt="Hitachi logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-10.webp" alt="L&T logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-25.webp" alt="HCL logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-31.webp" alt="Directi logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-26.webp" alt="Oracle logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-27.webp" alt="RBS logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-28.webp" alt="Bank of America logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-29.webp" alt="ICICI Securities logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-30.webp" alt="Muthoot Finance logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-32.webp" alt="Godrej logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-33.webp" alt="Motorola logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-34.webp" alt="TATA AIA logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-35.webp" alt="Radisson logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-36.webp" alt="ITC logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-37.webp" alt="Jubilant Foodworks logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-38.webp" alt="Le Meridian logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-39.webp" alt="Taj logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-8.webp" alt="Samsung logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-14.webp" alt="Honda logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-40.webp" alt="Taj logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-41.webp" alt="Anchor logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-42.webp" alt="Vardhaman logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-43.webp" alt="E&Y logo" width="150">
                    </div>
                    <div class="tcl-item">
                        <img class="lazy-img" data-src="includes/assets/images/p-logo-44.webp" alt="Cipla logo" width="150">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="usps-section position-relative">
        <div class="container">
            <div class="mainHeading text-center position-relative" data-aos="fade-up" data-aos-duration="500">
                <h2 class="immerse-heading"><span>Immerse yourself</span> in a Global <br>Educational Experience with peers<br> from 65 countries</h2>
            </div>
            
            <div role="list" class="key-figures-wrapper">
                <div role="listitem" class="key-figure-wrapper vertwrap">
                    <div class="key-figure-closed"><img data-src="latest-assets/img/key-plus.svg" alt="accordion expand icon" class="lazy-img key-figure-closed-close-icon" />
                        <div class="h3 key-figure-closed-title light whitespace-nowrap">Multicultural Campus</div>
                    </div>
                    <div class="key-figure-details"><img data-src="latest-assets/img/multi-campus-bg.webp" alt="a group of people from various cultures smile as they pose for the photo" sizes="100vw" class="lazy-img key-figure-image" />
                        <div class="key-figure-gradient"></div>
                        <div class="key-figure-details-wrapper">
                            <div class="display-1 regular text-white">Multicultural Campus</div>
                            <div class="key-para-cov">
                                <div class="body-1 light text-white kpi">Experience cultural diversity with students from 65+ countries, all 28 Indian states, and its 8 union territories</div>
                                <a href="https://www.cuchd.in/campus-life/index.php" target="_blank" class="btn btn-primary btn-hoverEffect">View More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a> 
                            </div>
                        </div>
                    </div>
                </div>
                <div role="listitem" class="key-figure-wrapper vertwrap">
                    <div class="key-figure-closed"><img data-src="latest-assets/img/key-plus.svg" alt="accordion expand icon" class="lazy-img key-figure-closed-close-icon" />
                        <div class="h3 key-figure-closed-title light whitespace-nowrap">Global Collaborations</div>
                    </div>
                    <div class="key-figure-details"><img data-src="latest-assets/img/cuUsp-carrer-globalCollab.webp" alt="a group of people from various cultures smile as they pose for the photo" sizes="100vw" class="lazy-img key-figure-image" />
                        <div class="key-figure-gradient"></div>
                        <div class="key-figure-details-wrapper">
                            <div class="display-1 regular text-white">Global Collaborations</div>
                            <div class="key-para-cov">                            
                                <div class="body-1 light text-white kpi">515+ partnerships with top-ranked universities worldwide</div>
                                <a href="https://www.cuchd.in/international-partners/" target="_blank" class="btn btn-primary btn-hoverEffect">View More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div role="listitem" class="key-figure-wrapper vertwrap">
                    <div class="key-figure-closed"><img data-src="latest-assets/img/key-plus.svg" alt="accordion expand icon" class="lazy-img key-figure-closed-close-icon" />
                        <div class="h3 key-figure-closed-title light whitespace-nowrap">Dual-Degree Opportunities</div>
                    </div>
                    <div class="key-figure-details"><img data-src="latest-assets/img/cuUsp-carrer-dualDegree.webp" alt="a group of people from various cultures smile as they pose for the photo" sizes="100vw" class="lazy-img key-figure-image" />
                        <div class="key-figure-gradient"></div>
                        <div class="key-figure-details-wrapper">
                            <div class="display-1 regular text-white">Dual-Degree Opportunities</div>
                            <div class="key-para-cov">                            
                                <div class="body-1 light text-white kpi">Pursue articulation programs, participate in study tours, and engage in cultural exchange programs</div>
                                <a href="https://www.cuchd.in/international/program-search-criteria.php" target="_blank" class="btn btn-primary btn-hoverEffect">View More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a>                             
                            </div>
                        </div>
                    </div>
                </div>
                <div role="listitem" class="key-figure-wrapper vertwrap">
                    <div class="key-figure-closed"><img data-src="latest-assets/img/key-plus.svg" alt="accordion expand icon" class="lazy-img key-figure-closed-close-icon" />
                        <div class="h3 key-figure-closed-title light whitespace-nowrap">Language and Culture</div>
                    </div>
                    <div class="key-figure-details"><img data-src="latest-assets/img/cuUsp-carrer-language.webp" alt="a group of people from various cultures smile as they pose for the photo" sizes="100vw" class="lazy-img key-figure-image" />
                        <div class="key-figure-gradient"></div>
                        <div class="key-figure-details-wrapper">
                            <div class="display-1 regular text-white">Language and Culture</div>
                            <div class="key-para-cov">                            
                                <div class="body-1 light text-white kpi">Develop global communication skills in a culturally rich environment</div>
                                <a href="https://www.cuchd.in/campus-life/clubs-and-student-chapters.php" target="_blank" class="btn btn-primary btn-hoverEffect">View More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a>                             
                            </div>
                        </div>
                    </div>
                </div>
                <div role="listitem" class="key-figure-wrapper vertwrap">
                    <div class="key-figure-closed"><img data-src="latest-assets/img/key-plus.svg" alt="accordion expand icon" class="lazy-img key-figure-closed-close-icon" />
                        <div class="h3 key-figure-closed-title light whitespace-nowrap">International Research Projects</div>
                    </div>
                    <div class="key-figure-details"><img data-src="latest-assets/img/cuUsp-carrer-research.webp" alt="a group of people from various cultures smile as they pose for the photo" sizes="100vw" class="lazy-img key-figure-image" />
                        <div class="key-figure-gradient"></div>
                        <div class="key-figure-details-wrapper">
                            <div class="display-1 regular text-white">International Research Projects</div>
                            <div class="key-para-cov">                            
                                <div class="body-1 light text-white kpi">250+ collaborations with renowned institutions in 60 countries to pursue international research projects</div>
                                <a href="https://www.cuchd.in/research/" target="_blank" class="btn btn-primary btn-hoverEffect">View More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a>                             
                            </div>
                        </div>
                    </div>
                </div>
                <div role="listitem" class="key-figure-wrapper vertwrap">
                    <div class="key-figure-closed"><img data-src="latest-assets/img/key-plus.svg" alt="accordion expand icon" class="lazy-img key-figure-closed-close-icon" />
                        <div class="h3 key-figure-closed-title light whitespace-nowrap">International Faculty</div>
                    </div>
                    <div class="key-figure-details"><img data-src="latest-assets/img/cuUsp-carrer-faculity.webp" alt="a group of people from various cultures smile as they pose for the photo" sizes="100vw" class="lazy-img key-figure-image" />
                        <div class="key-figure-gradient"></div>
                        <div class="key-figure-details-wrapper">
                            <div class="display-1 regular text-white">International Faculty</div>
                            <div class="key-para-cov">                            
                                <div class="body-1 light text-white kpi">Learn from globally renowned academicians and experts</div>
                                <a href="https://www.cuchd.in/campus-life/international-faculties.php" target="_blank" class="btn btn-primary btn-hoverEffect">View More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a>                             
                            </div>
                        </div>
                    </div>
                </div>
                <div role="listitem" class="key-figure-wrapper vertwrap">
                    <div class="key-figure-closed"><img data-src="latest-assets/img/key-plus.svg" alt="accordion expand icon" class="lazy-img key-figure-closed-close-icon" />
                        <div class="h3 key-figure-closed-title light whitespace-nowrap">Career Pathways</div>
                    </div>
                    <div class="key-figure-details"><img data-src="latest-assets/img/cuUsp-carrer-pathways.webp" alt="a group of people from various cultures smile as they pose for the photo" sizes="100vw" class="lazy-img key-figure-image" />
                        <div class="key-figure-gradient"></div>
                        <div class="key-figure-details-wrapper">
                            <div class="display-1 regular text-white">Career Pathways</div>
                            <div class="key-para-cov">                            
                                <div class="body-1 light text-white kpi">Access international job markets through robust global networks and internship opportunities</div>
                                <a href="https://www.cuchd.in/placements/" target="_blank" class="btn btn-primary btn-hoverEffect">View More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a>                             
                            </div>
                        </div>
                    </div>
                </div>                
    ...
    <section class="ads">  
        <div class="container">
            <div class="row px-188">
                <div class="col-xl-12">
                    <div class="card shadow mt-0 mt-xxl-5 adsCard">
                        <div class="card-body p-0">
                            <div class="row align-items-center">
                                <div class="col-sm-8 d-flex align-items-center position-relative adSlider">
                                    <div class="adSlider__title">
                                        <h4 data-aos="fade-right" data-aos-duration="500">Education That Empowers</h4>
                                        <h3 data-aos="fade-left" data-aos-duration="500">Opportunities That Transform</h3>
                                    </div>
                                </div>
                                <div class="col-sm-4 text-sm-end">
                                    <a href="https://cucet.cuchd.in/index.aspx?utm_source=Blogs&utm_medium=cuchd" target="_blank" class="adsCtabtn btn btn-primary btn-hoverEffect" data-aos="fade-left" data-aos-duration="500">Apply Now <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a>
                                </div>
                            </div>
                        </div>
                        <div class="adbanner lazy-bg" data-aos="fade-left" data-aos-duration="500" style="background-image: url('latest-assets/img/ads-placeholder-bg.webp');" data-bg="latest-assets/img/ads-bg.webp"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="mid-slider">
        <div class="ms-item lazy-bg" style="background-image:url('latest-assets/img/mid-slider-placeholder-bg.webp');" data-bg="latest-assets/img/mid-slider-bg-1.webp"></div>
        <div class="ms-item lazy-bg" style="background-image:url('latest-assets/img/mid-slider-placeholder-bg.webp');" data-bg="latest-assets/img/mid-slider-bg-2.webp"></div>
    </section>
    ...
    <section class="cuFeatures-section pt-115 pb-115 position-relative">
        <div class="container">
            ...
            <div class="px-188 px-1399"> 
                <div role="list" class="key-figures-wrapper">
                    <div role="listitem" class="key-figure-wrapper clickwrp active">
                        <span>01</span>
                        <div class="key-figure-closed">
                            <img data-src="latest-assets/img/right-arrow-blk.webp" alt="accordion expand icon" class="lazy-img key-figure-closed-close-icon" />
                            <div class="h3 key-figure-closed-title light whitespace-nowrap">High-Impact Networking Connections</div>
                        </div>
                        <div class="key-figure-details">
                            <div class="key-figure-details-wrapper">
                                <div class="key-para-cov">
                                    <div>
                                        <div class="display-1 regular">High-Impact Networking Connections</div>
                                        <div class="body-1 light text-dark kpi">Connect with an extensive network of top CEOs, Nobel Laureates, eminent entrepreneurs, top scientists, industry innovators, and global academicians for collaboration, mentorship, and career advancement opportunities.</div>
                                    </div>
                                    <div class="two-images">
                                        <img class="lazy-img" data-src="latest-assets/img/high-impact1.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="500">
                                        <img class="lazy-img" data-src="latest-assets/img/high-impact2.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="700">
                                    </div> 
                                </div>
                            </div>
                        </div>
                    </div>
                    <div role="listitem" class="key-figure-wrapper clickwrp" data-aos="fade-up" data-aos-duration="500">
                        <span>02</span>
                        <div class="key-figure-closed">
                            <img data-src="latest-assets/img/right-arrow-blk.webp" alt="accordion expand icon" class="lazy-img key-figure-closed-close-icon" />
                            <div class="h3 key-figure-closed-title light whitespace-nowrap">Tech-driven collaborative and fluid learning environments</div>
                        </div>
                        <div class="key-figure-details">
                            <div class="key-figure-details-wrapper">
                                <div class="key-para-cov">
                                    <div>
                                        <div class="display-1 regular">Tech-driven collaborative and fluid learning environments</div>
                                        <div class="body-1 light text-dark kpi">Go beyond conventional learning approaches and engage in industry-embedded learning, contextualized problem-solving, immersive simulations, interactive digital platforms, and professional certifications that align with the pace of emerging industries and technologies. </div>
                                    </div>
                                    <div class="two-images mt-30x">
                                        <img class="lazy-img" data-src="latest-assets/img/tech1.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="500">
                                        <img class="lazy-img" data-src="latest-assets/img/tech2.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="700">
                                    </div> 
                                </div>
                            </div>
                        </div>
                    </div>       
                    <div role="listitem" class="key-figure-wrapper clickwrp" data-aos="fade-up" data-aos-duration="700">
                        <span>03</span>
                        <div class="key-figure-closed">
                            <img data-src="latest-assets/img/right-arrow-blk.webp" alt="accordion expand icon" class="lazy-img key-figure-closed-close-icon" />
                            <div class="h3 key-figure-closed-title light whitespace-nowrap">360-degree support in building a personal brand</div>
                        </div>
                        <div class="key-figure-details">
                            <div class="key-figure-details-wrapper">
                                <div class="key-para-cov">
                                    <div>
                                        <div class="display-1 regular">360-degree support in building a personal brand</div>
                                        <div class="body-1 light text-dark kpi">Carve out a niche in the professional arena by elevating your personal brand through leadership programs and personalised mentorship, gaining attributes like resilience, adaptability, and strategic foresight, and emerging as a goal-oriented individual.</div>
                                    </div>
                                    <div class="two-images mt-30x">
                                        <img class="lazy-img" data-src="latest-assets/img/360-1.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="500">
                                        <img class="lazy-img" data-src="latest-assets/img/360-2.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="700">
                                    </div> 
                                </div>
                            </div>
                        </div>
                    </div> 
                    <div role="listitem" class="key-figure-wrapper clickwrp" data-aos="fade-up" data-aos-duration="900">
                        <span>04</span>
                        <div class="key-figure-closed">
                            <img data-src="latest-assets/img/right-arrow-blk.webp" alt="accordion expand icon" class="lazy-img key-figure-closed-close-icon" />
                            <div class="h3 key-figure-closed-title light whitespace-nowrap">Multi-Disciplinary University</div>
                        </div>
                        <div class="key-figure-details">
                            <div class="key-figure-details-wrapper">
                                <div class="key-para-cov">
                                    <div>
                                        <div class="display-1 regular">Multi-Disciplinary University</div>
                                        <div class="body-1 light text-dark kpi">Immerse yourself in a multidisciplinary educational experience with 18 specialised schools, offering more than 140 programs across diverse domains, including engineering, management, sciences, law, hospitality, and more.</div>
                                    </div>
                                    <div class="two-images mt-30x">
                                        <img class="lazy-img" data-src="latest-assets/img/multi-disciplinary1.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="500">
                                        <img class="lazy-img" data-src="latest-assets/img/multi-disciplinary2.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="700">
                                    </div> 
                                </div>
                            </div>
                        </div>
                    </div> 
                    <div role="listitem" class="key-figure-wrapper clickwrp" data-aos="fade-up" data-aos-duration="1100">
                        <span>05</span>
                        <div class="key-figure-closed">
                            <img data-src="latest-assets/img/right-arrow-blk.webp" alt="accordion expand icon" class="lazy-img key-figure-closed-close-icon" />
                            <div class="h3 key-figure-closed-title light whitespace-nowrap">Global Vision</div>
                        </div>
                        <div class="key-figure-details">
                            <div class="key-figure-details-wrapper">
                                <div class="key-para-cov">
                                    <div>
                                        <div class="display-1 regular">Global Vision</div>
                                        <div class="body-1 light text-dark kpi">Develop a global perspective through our study overseas programs and research opportunities, offered in collaboration with more than 515+ prestigious institutions in 100 countries.</div>
                                    </div>
                                    <div class="two-images mt-30x">
                                        <img class="lazy-img" data-src="latest-assets/img/global-1.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="500">
                                        <img class="lazy-img" data-src="latest-assets/img/global-2.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="700">
                                    </div> 
                                </div>
                            </div>
                        </div>
                    </div> 
                    <div role="listitem" class="key-figure-wrapper clickwrp" data-aos="fade-up" data-aos-duration="1300">
                        <span>06</span>
                        <div class="key-figure-closed">
                            <img data-src="latest-assets/img/right-arrow-blk.webp" alt="accordion expand icon" class="lazy-img key-figure-closed-close-icon" />
                            <div class="h3 key-figure-closed-title light whitespace-nowrap">Intercontinental research frontiers &amp; Innovation ecosystems</div>
                        </div>
                        <div class="key-figure-details">
                            <div class="key-figure-details-wrapper">
                                <div class="key-para-cov">
                                    <div>
                                        <div class="display-1 regular">Intercontinental research frontiers &amp; Innovation ecosystems</div>
                                        <div class="body-1 light text-dark kpi">Access cutting-edge tools and technologies while engaging in groundbreaking research across diverse domains through international collaborations with 250+ esteemed institutions in 60 countries.</div>
                                    </div>
                                    <div class="two-images mt-30x">
                                        <img class="lazy-img" data-src="latest-assets/img/interconinental-1.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="500">
                                        <img class="lazy-img" data-src="latest-assets/img/interconinental-2.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="700">
                                    </div> 
                                </div>
                            </div>
                        </div>
                    </div> 
                    <div role="listitem" class="key-figure-wrapper clickwrp" data-aos="fade-up" data-aos-duration="1500">
                        <span>07</span>
                        <div class="key-figure-closed">
                            <img data-src="latest-assets/img/right-arrow-blk.webp" alt="accordion expand icon" class="lazy-img key-figure-closed-close-icon" />
                            <div class="h3 key-figure-closed-title light whitespace-nowrap">Career Advancement</div>
                        </div>
                        <div class="key-figure-details">
                            <div class="key-figure-details-wrapper">
                                <div class="key-para-cov">
                                    <div>
                                        <div class="display-1 regular">Career Advancement</div>
                                        <div class="body-1 light text-dark kpi">Experience an unparalleled blend of personalised career mapping sessions, competitive and civil services exam preparation, exclusive internship and placement opportunities, and entrepreneurial training for global career pathways.</div>
                                    </div>
                                    <div class="two-images mt-30x">
                                        <img class="lazy-img" data-src="latest-assets/img/career-1.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="500">
                                        <img class="lazy-img" data-src="latest-assets/img/career-2.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="700">
                                    </div> 
                                </div>
                            </div>
                        </div>
                    </div> 
                    <div role="listitem" class="key-figure-wrapper clickwrp" data-aos="fade-up" data-aos-duration="1700">
                        <span>08</span>
                        <div class="key-figure-closed">
                            <img data-src="latest-assets/img/right-arrow-blk.webp" alt="accordion expand icon" class="lazy-img key-figure-closed-close-icon" />
                            <div class="h3 key-figure-closed-title light whitespace-nowrap">Global Alumni Network</div>
                        </div>
                        <div class="key-figure-details">
                            <div class="key-figure-details-wrapper">
                                <div class="key-para-cov">
                                    <div>
                                        <div class="display-1 regular">Global Alumni Network</div>
                                        <div class="body-1 light text-dark kpi">Network with more than 1,00,000 accomplished alumni excelling globally as entrepreneurs and professionals in top MNCs like Google, Microsoft and Amazon.</div>
                                    </div>
                                    <div class="two-images mt-30x">
                                        <img class="lazy-img" data-src="latest-assets/img/global-alumni-1.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="500">
                                        <img class="lazy-img" data-src="latest-assets/img/global-alumni-2.webp" alt="Foreign Alma Mater Person" data-aos="fade-up" data-aos-duration="700">
                                    </div> 
                                </div>
                            </div>
                        </div>
    ...
    <section class="studentTestimonial-section pt-115 pb-115 position-relative">
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <div class="mainHeading position-relative">
                        <p class="text-white" data-aos="fade-left" data-aos-duration="500">Students Speak</p>                
                        <h2 class="text-white" data-aos="fade-right" data-aos-duration="900"><span>Discover the inspiring stories</span> and gain valuable insights straight from our accomplished graduates</h2>
                    </div>
                    <div class="px-188 order-sm-set">
                        <div class="for-testimony" data-aos="fade-up" data-aos-duration="500">
                            <div class="ft-item">
                                <img class="w-100 lazy-img" data-src="latest-assets/img/student-test-thumb-5.webp" alt="testimony slide thumbnail">
                                <span>Shardul J.</span>
                            </div>
                            <div class="ft-item">
                                <img class="w-100 lazy-img" data-src="latest-assets/img/student-test-thumb-2.webp" alt="testimony slide thumbnail">
                                <span>Anand B.</span>
                            </div>
                            <div class="ft-item">
                                <img class="w-100 lazy-img" data-src="latest-assets/img/student-test-thumb-3.webp" alt="testimony slide thumbnail">
                                <span>Arshdeep S.</span>
                            </div> 
                            <div class="ft-item">
                                <img class="w-100 lazy-img" data-src="latest-assets/img/student-test-thumb-4.webp" alt="testimony slide thumbnail">
                                <span>Vandana C.</span>
                            </div>                            
                        </div>
                        <div class="mt-5" data-aos="fade-up" data-aos-duration="500">
                            <a href="testimonials.php" class="btn btn-primary bg-white text-dark btn-hoverEffect" target="_blank">Read All Reviews <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="22" class="lazy-img ms-2"></a>
                        </div>                         
                    </div>                   
                </div>
                <div class="col-md-7">
                    <div class="testimony-slider">
                        <div class="test-item">
                            <img class="ts-desk lazy-img" data-src="latest-assets/img/student-test-5.webp" alt="Shardul Testimonial" width="943">
                            <img class="ts-mob lazy-img" data-src="latest-assets/img/student-test-5-mob.webp" alt="Shardul Testimonial">
                        </div>
                        <div class="test-item">
                            <img class="ts-desk lazy-img" data-src="latest-assets/img/student-test-2.webp" alt="Anand Testimonial" width="943">
                            <img class="ts-mob lazy-img" data-src="latest-assets/img/student-test-2-mob.webp" alt="Anand Testimonial">
                        </div>
                        <div class="test-item">
                            <img class="ts-desk lazy-img" data-src="latest-assets/img/student-test-3.webp" alt="Arshdeep Testimonial" width="943">
                            <img class="ts-mob lazy-img" data-src="latest-assets/img/student-test-3-mob.webp" alt="Arshdeep Testimonial">
                        </div>
                        <div class="test-item">
                            <img class="ts-desk lazy-img" data-src="latest-assets/img/student-test-4.webp" alt="Vandana Testimonial" width="943">
                            <img class="ts-mob lazy-img" data-src="latest-assets/img/student-test-4-mob.webp" alt="Vandana Testimonial">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="cuResearch-section position-relative">
        <div class="container">
            <div class="mainHeading" data-aos="fade-right" data-aos-duration="500">
                <h2>Pioneering <span>Research</span></h2>
            </div>
            <div class="topHighlights__numbers px-188 px-1399 d-flex justify-content-between" id="counter-section2">
                <div class="tpNumbersCard">
                    <span class="count plusIcon" data-count="20000">0</span>
                    <p data-aos="fade-right" data-aos-duration="500">Publications in National &amp; <br>International Journals</p>
                </div>
                <div class="tpNumbersCard">
                    <span class="count plusIcon" data-count="5000">0</span>
                    <p data-aos="fade-right" data-aos-duration="500">Patents filed by Chandigarh <br>University Successfully</p>
                </div>
                <div class="tpNumbersCard">
                    <span class="count plusIcon" data-count="200">0</span>
                    <p data-aos="fade-right" data-aos-duration="500">Departmental Research <br>Groups</p>
                </div>
                <div class="tpNumbersCard">
                    <span class="count plusIcon" data-count="20">0</span>
                    <p data-aos="fade-right" data-aos-duration="500">Industry-Collaborated <br>Centres of Excellence</p>
                </div>               
            </div>
        </div>
        
            <div class="ps-188 position-relative">
                <div class="researchLabs-slider mt-sm-5">
                    <div class="researchLabs-item">
                        <img data-src="latest-assets/img/cuResearch-lab-kcc.webp" alt="KCC Lab" class="lazy-img w-100 h-100">
                        <div class="box">
                            <h3 class="title">KCC Lab</h3>
                            <p>The KCCRSST is giving satellite design training to students of 21 countries. The Space Centre can communicate with 28 countries that are part of Satellite Networked Open Ground Station (SatNOGS).</p>     
                        </div>                        
                    </div>
                    <div class="researchLabs-item">
                        <img data-src="latest-assets/img/research-lab-automobile.webp" alt="Automobile Lab" class="lazy-img w-100 h-100">
                        <div class="box">
                            <h3 class="title">Eicher-CU Centre of Excellence</h3>
                            <p>The centre offers live workshops by industry experts, hands-on practice for students, and research on blended fuel efficiency, BS-VI commercial heavy diesel engines, and BS-VI engine emissions control techniques.</p>     
                        </div>                        
                    </div>  
                    <div class="researchLabs-item">
                        <img data-src="latest-assets/img/cuCenterOfExcellence-UltraTech.webp" alt="Ultratech Lab" class="lazy-img w-100 h-100">
                        <div class="box">
                            <h3 class="title">CoE-Ultratech Lab</h3>
                            <p>The CoE aims to drive research and development, facilitate industry-academia collaboration, enhance skill development, and create pathways for student placements in the construction and materials sector.</p>     
                        </div>                        
                    </div>  
                    <div class="researchLabs-item">
                        <img data-src="latest-assets/img/cuResearch-lab-coforge.webp" alt="Coforge Lab" class="lazy-img w-100 h-100">
                        <div class="box">
                            <h3 class="title">Coforge Lab</h3>
                            <p>Innovation center responsible for developing solutions for real-world problems at national and international levels, advancing autonomous vehicles, and conducting R&D on AI applications in healthcare.</p>     
                        </div>                        
                    </div>    
                    <div class="researchLabs-item">
                        <img data-src="latest-assets/img/cuHotel-Management-LIVE-Kitchen.webp" alt="Hotel Management LIVE Kitchen" class="lazy-img w-100 h-100">
                        <div class="box">
                            <h3 class="title">LIVE Kitchen</h3>
                            <p>Our LIVE Kitchen serves as a dynamic learning space where culinary creativity meets professional expertise. Designed like an industry-standard kitchen, it offers students experiential training in food production, presentation, and modern gastronomy techniques, preparing them to excel in hospitality and global culinary arts.</p>   
                        </div>                        
                    </div>                      
                    <div class="researchLabs-item">
                        <img data-src="latest-assets/img/cuElectrical-Engineering.webp" alt="Electrical Engineering Lab" class="lazy-img w-100 h-100">
                        <div class="box">
                            <h3 class="title">Electrical Engineering Lab</h3>
                            <p>Equipped with advanced simulation tools and modern equipment, our Electrical Engineering Lab provides hands-on training in power systems, circuit design, control systems, and renewable energy applications. It bridges theoretical concepts with real-world applications, preparing students to innovate in the ever-evolving electrical and electronics industry.</p>     
                        </div>                        
                    </div>   
                    <div class="researchLabs-item">
                        <img data-src="latest-assets/img/cuMechanicalEngineering-Workshop.webp" alt="Mechanical Engineering Workshop" class="lazy-img w-100 h-100">
                        <div class="box">
                            <h3 class="title">M.E. Workshop</h3>
                            <p>The Mechanical Engineering Workshop nurtures innovation through practical exposure to machining, fabrication, welding, and prototyping. Students gain first-hand experience in core mechanical processes, supported by state-of-the-art tools and machines, ensuring readiness for both industrial challenges and cutting-edge research.</p>   
                        </div>                        
                    </div>  
                    <div class="researchLabs-item">
                        <img data-src="latest-assets/img/cuMediaStudios-Journalism.webp" alt="Media Studios -Journalism" class="lazy-img w-100 h-100">
                        <div class="box">
                            <h3 class="title">Media Studios</h3>
                            <p>Our Media Studios are designed to immerse students in the fast-paced world of journalism and digital media. With industry-standard equipment for news production, editing, and broadcasting, these studios provide hands-on training that fosters storytelling, creativity, and ethical reporting across multiple platforms.</p>   
                        </div>                        
                    </div>  
                    <div class="researchLabs-item">
                        <img data-src="latest-assets/img/cuMootCourt-Legal-Studies.webp" alt="Moot Court - Legal Studies" class="lazy-img w-100 h-100">
                        <div class="box">
                            <h3 class="title">Moot Court</h3>
                            <p>The Moot Court replicates real courtroom settings, allowing law students to sharpen advocacy, argumentation, and legal reasoning skills. By engaging in simulated trials, debates, and case studies, it cultivates confidence, professionalism, and practical exposure to the judicial system.</p>   
                        </div>                        
                    </div>                      
                </div>
            </div>        
    ...
    <section class="cuNews-section pt-115 pb-115 position-relative" data-aos="fade-up" data-aos-duration="500">
        <div class="container">
            <div class="mainHeading text-center position-relative" data-aos="fade-up" data-aos-duration="700">
                <h2><span>News</span> and Events</h2>
            </div>

            <div class="row d-flex justify-content-center">
                <div class="col-xl-3 col-lg-6 order-nw-2">
                    <div class="row small-cards g-0">
                        <div class="col-lg-12 col-sm-6" data-aos="fade-right" data-aos-duration="500">
                            <div class="card p-0 pt-0 border-0 position-relative h-100">
                                <div class="row">
                                    <div class="col-lg-5 col-sm-12 col-5 nw-img lazy-bg" style="background-image: url('latest-assets/img/cuNews-placeholder-bg.webp');" data-bg="latest-assets/img/cuNews-6.webp">
                                    </div>
                        ...
                        <div class="col-lg-12 col-sm-6" data-aos="fade-right" data-aos-duration="700">
                            <div class="card p-0 border-0 position-relative h-100">
                                <div class="row">
                                    <div class="col-lg-5 col-sm-12 col-5 nw-img lazy-bg" style="background-image: url('latest-assets/img/cuNews-placeholder-bg.webp');" data-bg="latest-assets/img/cuNews-4.webp">
                                    </div>
                                    <div class="col-lg-7 col-sm-12 col-7">
                                        <div class="nw-content">
                        ...
                        <div class="col-lg-12 col-sm-6" data-aos="fade-right" data-aos-duration="900">
                            <div class="card p-0 border-0 position-relative h-100">
                                <div class="row">
                                    <div class="col-lg-5 col-sm-12 col-5 nw-img lazy-bg" style="background-image: url('latest-assets/img/cuNews-placeholder-bg.webp'); background-position: left;" data-bg="latest-assets/img/cuNews-7.webp">
                                    </div>
                                    <div class="col-lg-7 col-sm-12 col-7">
                                        <div class="nw-content">
                        ...
                        <div class="col-lg-12 col-sm-6" data-aos="fade-right" data-aos-duration="1100">
                            <div class="card p-0 border-0 position-relative h-100">
                                <div class="row">
                                    <div class="col-lg-5 col-sm-12 col-5 nw-img lazy-bg" style="background-image: url('latest-assets/img/cuNews-placeholder-bg.webp');" data-bg="latest-assets/img/cuNews-3.webp">
                                    </div>
                                    <div class="col-lg-7 col-sm-12 col-7">
                                        <div class="nw-content">
                ...
                <div class="col-lg-6 order-nw-1" data-aos="fade-up" data-aos-duration="800">
                    <div class="card p-0 border-0 position-relative h-100 bigNews">
                        <div class="row">
                            <div class="col-md-12 nw-img lazy-bg" style="background-image: url('latest-assets/img/cuNews-big-placeholder-bg.webp');" data-bg="latest-assets/img/epam-placements-img.webp">
                            </div>
                            <div class="col-md-12">
                                <div class="nw-content">
                                    <span class="nw-date">Nov 14 | Placements</span>
                                    <a class="str-link" href="https://www.cuchd.in/blogs/chandigarh-university-makes-national-record-in-placement.php" target="_blank" rel="nofollow">Reaffirming Its Standing as the University With the Best Placements, CU Has Secured India’s Highest 70 EPAM Placement Offers at ₹8 LPA!</span>
                                    <span class="nw-link"><a class="btn btn-primary btn-hoverEffect" href="https://www.cuchd.in/blogs/chandigarh-university-makes-national-record-in-placement.php" target="_blank" rel="nofollow">Read More <img data-src="latest-assets/img/right-arrow-btn.webp" alt="Button Arrow" width="16" class="lazy-img ms-2"></a></span>
                                </div>
                            </div>
                        </div>
                    </div>                    
                </div> 
                <div class="col-xl-3 col-lg-12 order-nw-3">
                    <div class="row medcards g-0">
                        <div class="col-sm-6 col-xl-12" data-aos="fade-left" data-aos-duration="500">
                            <div class="card p-0 pt-0 border-0 position-relative h-100">
                                <div class="row">
                                    <div class="col-md-12 nw-img lazy-bg" style="background-image: url('latest-assets/img/cuNews-right-placeholder-bg.webp');" data-bg="latest-assets/img/gaurav-taneja-bg.webp">
                                    </div>
                        ...
                        <div class="col-sm-6 col-xl-12" data-aos="fade-left" data-aos-duration="700">
                            <div class="card p-0 border-0 position-relative h-100">
                                <div class="row">
                                    <div class="col-md-12 nw-img lazy-bg" style="background-image: url('latest-assets/img/cuNews-right-placeholder-bg.webp');" data-bg="latest-assets/img/kamya-jani.webp">
                                    </div>
                                    <div class="col-md-12 bg-white">
                                        <div class="nw-content">
        ...
        <div class="container">
            ...
            <div class="cuMap-section__in position-relative lazy-bg" style="background-image: url('latest-assets/img/map-placeholder.webp'); background-size: cover; background-position: center 50%" data-bg="latest-assets/img/map.webp">
                <div class="homePageMap-iframe h-100 position-relative" id="vMap">
                    <iframe src="https://iviewd.com/cu2/" width="100%" height="100%" frameborder="0" style="border:0" loading="lazy"></iframe>
                </div>
                <div class="text-center mt-4 mb-4 vMap-btn">
                    <a href="maps/" class="btn btn-primary" target="_blank">View Virtual Tour</a>
                </div>
            </div>
        </div>
    </section>
...
<script>
    ...
    <!-----------------------  EXIT INTENT POPUP ----------------->
<!--
    <link href="https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,300;9..40,800&display=swap"
    ...
    <div class="exit-intent-popup">
        <div class="newsletter">
            <div class="row g-0">
                <div class="col-md-6">
                    <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"><img
                            src="https://www.cuchd.in/exit-popup-img.webp" class="w-100" alt="banner"></a>
                </div>
                <div class="col-md-6">
                    <div class="popup-content">
                        <h2>Don't Miss out<br>on your opportunity<br>to support your<br>academics with<br><strong>upto
                                100%<br>Scholarship!</strong></h2>
                        <div class="mt-5">
                            <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
                                class="pop-btn">
                                Apply Now
            ...
            <span class="close"><svg fill="#b1b1b1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
                    <path
...
-->
    ...
    <script>
        ...
        window.addEventListener('load', function () {
            // Show the div after the page is fully loaded
    ...
    <script>
        ...
        addEvent(document, 'mouseout', function (evt) {
            if (evt.toElement == null && evt.relatedTarget == null && window.localStorage.toggled == "") {
                $('.exit-intent-popup').addClass('visible');
            }
        });

        $('.exit-intent-popup .close').click(function () {
            if (window.localStorage.toggled != "visible") {
                $('.exit-intent-popup').removeClass("visible");
                window.localStorage.toggled = "visible";
            } else {
                window.localStorage.toggled = "";
            }
        });        
    ...
    <script>
        ...
        $('.notifications__slider').flickity({
            cellAlign: 'left',
            pageDots: true,
            autoPlay: true,
            contain: true,
        ...
        $('.topHighlights__slider').flickityResponsive({
            cellAlign: 'left',
            pageDots: false,
            autoPlay: true,
            contain: true,
        ...
        $('.topCompaniesLogo-slider').flickity({
            cellAlign: 'left',
            pageDots: false,
            autoPlay: true,
            contain: true,
        ...
        $('.testimony-slider').flickity({
          asNavFor: '.for-testimony',
          cellAlign: 'left',            
          contain: true,
          pageDots: false,
          draggable: false,
        ...
        const initKeyFiguresOpenAnimation = () => {
          const firstKeyFigure = document.querySelector(
            ".key-figure-wrapper.vertwrap:nth-child(1)"
          );
          if (firstKeyFigure) {
            // define the first card as active
            firstKeyFigure.classList.add("active");
          }
        
          const keyFigures = document.querySelectorAll(".key-figure-wrapper.vertwrap");
        
          keyFigures.forEach((keyFigure) => {
            keyFigure.addEventListener("click", () => {
              if (keyFigure.classList.contains("active")) return;
              keyFigures.forEach((el) => el.classList.remove("active"));
              keyFigure.classList.add("active");
            });
          });
        };                
        //* KEY FIGURES OPEN ANIMATION
        initKeyFiguresOpenAnimation();  
        
        const initKeyFiguresOpenAnimation2 = () => {
          const firstKeyFigure2 = document.querySelector(
            ".key-figure-wrapper.clickwrp:nth-child(1)"
          );
          if (firstKeyFigure2) {
            // define the first card as active
            firstKeyFigure2.classList.add("active");
          }
        
          const keyFigures2 = document.querySelectorAll(".key-figure-wrapper.clickwrp");
        
          keyFigures2.forEach((keyFigure2) => {
            keyFigure2.addEventListener("click", () => {
              if (keyFigure2.classList.contains("active")) return;
              keyFigures2.forEach((el) => el.classList.remove("active"));
              keyFigure2.classList.add("active");
            });
          });
        };        
        //* KEY FIGURES OPEN ANIMATION
        initKeyFiguresOpenAnimation2();
        
        if ($(window).width() < 768) {
            $('#faq-head-4 button').removeAttr('disabled');
        }
        else {
            $('#faq-head-4 button').attr("disabled","");
        }
    </script>
